...
BOOL CDlgFilterPolygonSelection::OnInitDialog() 
{
  ...
  m_ctrlClusterSizeCombo.AddString( _T("3.125 cm"));
  m_ctrlClusterSizeCombo.AddString( _T("6.25 cm"));
  m_ctrlClusterSizeCombo.AddString( _T("12.5 cm"));
  m_ctrlClusterSizeCombo.AddString( _T("25 cm"));
  m_ctrlClusterSizeCombo.AddString( _T("0.5 m"));
  m_ctrlClusterSizeCombo.AddString( _T("1 m"));
  m_ctrlClusterSizeCombo.AddString( _T("2 m"));
  m_ctrlClusterSizeCombo.AddString( _T("4 m"));
  m_ctrlClusterSizeCombo.AddString( _T("8 m"));
  m_ctrlClusterSizeCombo.AddString( _T("16 m"));
  m_ctrlClusterSizeCombo.AddString( _T("32 m"));
  m_ctrlClusterSizeCombo.AddString( _T("64 m"));
  m_ctrlClusterSizeCombo.AddString( _T("128 m"));
  m_ctrlClusterSizeCombo.AddString( _T("256 m"));
  m_ctrlClusterSizeCombo.AddString( _T("512 m"));
  m_ctrlClusterSizeCombo.AddString( _T("1024 m"));
  m_ctrlClusterSizeCombo.SetCurSel( -1);

  m_ctrlClusterMemoryCombo.AddString( _T("256 kb"));
  m_ctrlClusterMemoryCombo.AddString( _T("128 kb"));
  m_ctrlClusterMemoryCombo.AddString( _T("32 kb"));
  m_ctrlClusterMemoryCombo.AddString( _T("16 kb"));
  m_ctrlClusterMemoryCombo.AddString( _T("8 kb"));
  m_ctrlClusterMemoryCombo.AddString( _T("4 kb"));
  m_ctrlClusterMemoryCombo.AddString( _T("2 kb"));
  m_ctrlClusterMemoryCombo.AddString( _T("1 kb"));
  m_ctrlClusterMemoryCombo.AddString( _T("512 bytes"));
  m_ctrlClusterMemoryCombo.AddString( _T("256 bytes"));
  m_ctrlClusterMemoryCombo.AddString( _T("128 bytes"));
  m_ctrlClusterMemoryCombo.AddString( _T("64 bytes"));
  m_ctrlClusterMemoryCombo.AddString( _T("32 bytes"));
  m_ctrlClusterMemoryCombo.AddString( _T("16 bytes"));
  m_ctrlClusterMemoryCombo.AddString( _T("8 bytes"));
  m_ctrlClusterMemoryCombo.AddString( _T("4 bytes"));
  m_ctrlClusterMemoryCombo.AddString( _T("2 bytes"));
  m_ctrlClusterMemoryCombo.AddString( _T("1 byte"));
